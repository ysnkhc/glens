    ...
    def analyze_contract(self, source_code: str) -> str:
        ...
        result = gl.eq_principle.prompt_non_comparative(
            lambda: gl.nondet.exec_prompt(
                ...
                "WARNINGS:\n"
                "- missing_depends_header: First line must be a comment starting with # { \"Depends\": \"py-genlayer:\" followed by any hash or the word 'latest' }. If the first line already starts with # { \"Depends\": then this rule PASSES — do NOT flag it\n"
